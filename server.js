  ...
  <body style="margin:0;padding:0;background:#f0f0f0;font-family:Arial,sans-serif;">
    <div style="max-width:580px;margin:24px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px   
  rgba(0,0,0,.12);">                                                                                                        
      ...
      <div style="padding:24px 28px;">                                                                                      
        <h2 style="margin:0 0 14px;font-size:15px;color:#333;text-transform:uppercase;letter-spacing:.6px;border-bottom:2px 
  solid #FF6B1A;padding-bottom:8px;">Customer Info</h2>                                                                     
  ...
  14px;font-size:15px;color:#333;text-transform:uppercase;letter-spacing:.6px;border-bottom:2px solid                       
  #FF6B1A;padding-bottom:8px;">Pickup Location</h2>
        <table style="width:100%;border-collapse:collapse;">                                                                
          <tr>                                              
        ...
        <h2 style="margin:20px 0                                                                                            
  14px;font-size:15px;color:#333;text-transform:uppercase;letter-spacing:.6px;border-bottom:2px solid                       
  #FF6B1A;padding-bottom:8px;">Service Details</h2>
        <table style="width:100%;border-collapse:collapse;">                                                                
          <tr>                                                                                                              
        ...
        <h2 style="margin:20px 0                                                                                            
  14px;font-size:15px;color:#333;text-transform:uppercase;letter-spacing:.6px;border-bottom:2px solid                       
  #FF6B1A;padding-bottom:8px;">Price</h2>                                                                                   
        <table style="width:100%;border-collapse:collapse;">                                                                
          <tr>                                              
